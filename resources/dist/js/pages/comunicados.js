$(document).ready(function() {
    ...
    if (typeof Dropzone != "undefined") {
        ...
        myDropzone = new Dropzone(document.body, {
            url: base_url + "comunicados/uploadfile",
            paramName: "file",
            maxFilesize: 10,
            maxFiles: 1,
            thumbnailWidth: 100,
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        if (vinid == "") {
                            ...
                            $.ajax({
                                url: base_url + 'comunicados/fn_delete_file',
                                type: 'POST',
                                data: {
                                    "codigo": vinid,
                                    "link": vilink
...
function vw_pw_cm_pr_fn_eliminar(btn) {
    ...
    Swal.fire({
        ...
        if (result.value) {
            ...
            $.ajax({
                url: base_url + 'comunicados/fn_delete',
                type: 'POST',
                data: {
                    "codigo": vinid
                },
...
function vw_pw_bt_ad_fn_uploadImage(image) {
    ...
    $.ajax({
        url: base_url + "comunicados/uploadimages",
        cache: false,
        contentType: false,
        processData: false,
        data: data,
...
function vw_pw_bt_ad_deleteFile(src) {
    $.ajax({
        ...
        type: "POST",
        url: base_url + "comunicados/delete_file", // replace with your url 
        cache: false,
