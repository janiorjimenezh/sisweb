                ...
                <ul class="order-list no-fondo" >
                    ...
                    switch ($mat->tipo) {
                            ...
                            if (isset($arr_arch[$mat->codigo])){
                                ...
                                if ($n>1){
                                    ...
                                    foreach ($files as $file) {
                                        ...
                                        $archivo=$vbaseurl."curso/virtual/archivos/$codmat/$coddet";
                        ...
                        $detalle='<div class="col-12 col-sm-8 offset-sm-2  col-md-6 offset-md-3 align-self-center py-3">
                            ...
                            /*$icon="<img class='mr-1' style='vertical-align: middle;display: inline-block' src='".$vbaseurl."resources/img/icons/p_ytb.png' alt='Youtube'>";
                            ...
                            break;
                        case 'T':
                            $icon="<img class='mr-1' style='vertical-align: middle;display: inline-block' src='".$vbaseurl."resources/img/icons/p_tarea.png' alt='TAREA'>";
                            //$archivo=$mat->link;
                            $ira=$vbaseurl.'monitoreo/docente/curso/virtual/tarea/'.$codcarga64.'/'.$coddivision64.'/'.$codmaterial64;
                            $nombre="<a class='text-danger' href='$ira'>$icon <span>$mat->nombre</span></a>";
                            $detalle=$mat->detalle;
                            break;
                        case 'V':
                            $icon="<img class='mr-1' style='vertical-align: middle;display: inline-block' src='".$vbaseurl."resources/img/icons/p_cuestionario.png' alt='EVALUACIÓN'>";
                            $ira=$vbaseurl.'monitoreo/docente/curso/virtual/evaluacion/'.$codcarga64.'/'.$coddivision64.'/'.$codmaterial64;
                            $nombre="<a class='text-danger' href='$ira'>$icon <span>$mat->nombre</span></a>";
                            $detalle=$mat->detalle;
                            break;
                        case 'F':
                            $icon="<img class='mr-1' style='vertical-align: middle;display: inline-block' src='".$vbaseurl."resources/img/icons/p_foro.png' alt='FORO'>";
                            //$archivo=$mat->link;
                            $ira=$vbaseurl.'monitoreo/docente/curso/virtual/foro/'.$codcarga64.'/'.$coddivision64.'/'.$codmaterial64;
                            $nombre="<a class='text-danger' href='$ira'>$icon <span>$mat->nombre</span></a>";
                            $detalle=$mat->detalle;
                            break;
                        case 'L':
                            $icon="<img class='mr-1' style='vertical-align: middle;display: inline-block' src='".$vbaseurl."resources/img/icons/p_url.png' alt='URL'>";
                            $archivo=$mat->link;
