        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            ...
            <?php if (isset($supervisa)){ ?>
               <li class="breadcrumb-item"><a href="<?php echo $vbaseurl.'monitoreo/docente/'.base64url_encode($curso->coddocente_principal).'/'.base64url_encode($curso->codperiodo).'/cursos'; ?>"><i class="fas fa-compass"></i></i> Panel de Monitoreo</a></li>
               <li class="breadcrumb-item active">Aula Virtual</li>
            <?php }
            else{ ?>
              <li class="breadcrumb-item"><a href="<?php echo $vbaseurl.'curso/panel/'.base64url_encode($curso->codcarga).'/'.base64url_encode($curso->division); ?>"><i class="fas fa-compass"></i></i> Panel</a></li>
            <?php } ?>
            </ol>
          </div>
        </div>
