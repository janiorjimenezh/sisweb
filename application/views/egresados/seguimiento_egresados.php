...
<div class="content-wrapper">
	...
	<section class="content">
		<div id="divboxdatos" class="card card-success">
			<div class="card-body">
				<table class="table table-bordered table-striped dt-responsive tablaEgresados" width="100%">
	                ...
	                <thead>
	                  	...
	                  	<tr>
	                    	...
	                    	<th>Condición</th>
	                    	<th>Año Egreso</th>
	                    	<th>Condición Trabaja</th>
	                    	<th>Procedencia Actual</th>
...
<script type="text/javascript">
	...
	$(".tablaEgresados").DataTable({
	  "ajax":base_url+"egresadosdts/dtsegresados",
	  "deferRender": true,
	  "retrieve": true,
	  "processing": true,
	  "language": {
