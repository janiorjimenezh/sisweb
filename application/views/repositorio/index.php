		...
		<div id="divcard_bolsa" class="card">
		    <div class="card-header">
		    	...
		    	<div class="no-padding card-tools">
                	<a type="button" class="btn btn-sm btn-default" href="<?php echo $vbaseurl ?>portal-web/repositorio/agregar"><i class="fa fa-plus"></i> Agregar</a>
              	</div>
		    </div>
            <div class="card-body">
                            ...
                            "<div class='row cfila'>
                                ...
                                <div class='col-12 col-md-3 text-center'>
                                    <div class='row'>
                                        ...
                                        <div class='col-sm-4 col-md-4 td'>
                                            <a href='{$vbaseurl}portal-web/repositorio/editar/$area/$codigo_enc'><i class='fas fa-pen fa-2x text-primary'></i></a>
                                        </div>
                                        
                                        <div class='col-sm-4 col-md-4 td'>
                                            <a href='#' data-area='$area' data-codigo='$codigo_enc' onclick='vw_pw_tp_pr_fn_eliminar_rg($(this));event.preventDefault();'><i class='fas fa-trash fa-2x text-danger'></i></a>
                                        </div>
...
<script type="text/javascript">
    $('#cbocategoria').change(function(event) {
        ...
        var codigo = $(this).val();
        $.ajax({
            url: base_url + 'repositorio/fn_search_data',
            type: 'post',
            dataType: 'json',
            data: {
                cbocategoria: codigo
    ...
    function vw_pw_tp_pr_fn_eliminar_rg(btn) {
        ...
        Swal.fire({
            ...
            if (result.value) {
                $('#divcard_bolsa').append('<div id="divoverlay" class="overlay"><i class="fas fa-spinner fa-pulse fa-3x"></i></div>');
                $.ajax({
                    url: base_url + 'repositorio/fn_delete',
                    type: 'POST',
                    data: {
                        "codigo": vinid,
                        "area": area
