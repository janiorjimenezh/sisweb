                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item">
                            <a href="<?php echo $vbaseurl ?>portal-web/lecturas-recomendadas">Lecturas Recomendadas</a>
                        </li>
                ...
                <form id="vw_pw_bt_ad_form_addDWeb" action="<?php echo $vbaseurl ?>bolsa/fn_insert_datos" method="post" accept-charset="utf-8">
                    <div class="row mt-2">
                        ...
                        <div class="col-12 px-3 text-center">
                            ...
                            <h5> Arrastra aquí tus archivos (1 archivo máx. - Peso 30 MB máx. c/u)</h5>
                        ...
                        <div class="col-12">
                            <a type="button" href="<?php echo $vbaseurl ?>portal-web/lecturas-recomendadas" class="btn btn-danger btn-md float-left" >
...
$("#vw_pw_bt_ad_btn_guardar").click(function(event) {
    ...
    $.ajax({
        url: base_url + 'lecturas_recomendadas/fn_guardar',
        type: 'POST',
        data: fdata,
        dataType: 'json',
        success: function(e) {
