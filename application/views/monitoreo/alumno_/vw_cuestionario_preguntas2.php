        ...
        echo "<div class='card-pregunta $vclase card  ml-sm-2 ml-md-3 card-outline $colorcard' data-numero='$vnum' >
                ...
                <div class='card-header px-2 px-sm-3 py-2 text-sm'>
                    ...
                    <div class='card-tools'>
                            <select data-currentvalue='$pgta->codtipo' name='pg-tipo' class='form-control-plaintext form-control-sm' title='Selecciona' required onchange='changeform($(this));' onblur='saveblurpg($(this));' data-tpcn='pg'>";
                ...
                <input onchange='changeform($(this));' onblur='saveblurpg($(this));' data-tpcn='pg' value='$codpregunta' type='hidden' data-currentvalue='$codpregunta' name='pg-codpg' min='1' >
                <input onchange='changeform($(this));' onblur='saveblurpg($(this));' data-tpcn='pg' value='$pgta->pos' type='hidden' data-currentvalue='$pgta->pos' name='pg-pos' min='1' >
                <div class='card-body px-2 px-sm-3 py-2'>
                    <div class='row'>
                        <div class='col-12 col-sm-11'>
                            <div class='row text-sm'>
                                <div class='col-12 col-md-12 mt-1'>
                                    <textarea onchange='changeform($(this));' onblur='saveblurpg($(this));' data-tpcn='pg' data-currentvalue='$pgta->enunciado' name='pg-enunciado' onkeyup='setaltura($(this));' rows='1' cols='80' class='form-control' placeholder='Enunciado'>$pgta->enunciado</textarea>
                                </div>
                                
                                <div class='col-12 mt-2'>
                                    <textarea onchange='changeform($(this));' onblur='saveblurpg($(this));' data-tpcn='pg' data-currentvalue='$pgta->enunciadox' name='pg-descripcion' onkeyup='setaltura($(this));' class='form-control' rows='1' placeholder='Descripción'>$pgta->enunciadox</textarea>
                                </div>
                            </div>
                    ...
                    <div class='row text-sm'>
                        ...
                        <div class='col-6 col-md-2 mt-2'>
                            <div class='form-group has-float-label'>
                                <input onchange='changeform($(this));' onblur='saveblurpg($(this));' data-tpcn='pg' type='number' data-currentvalue='$pgta->valor' name='pg-valor' min='0' class='form-control form-control-sm' placeholder='Valor' value='$vmax' step='1'>
                                <label for='pg-valor'>Puntos</label>
                            </div>
                        </div>
                        <div class='col-6 col-sm-3 col-md-2 mt-2'>
                            
                            <input onchange='changeform($(this));' onblur='saveblurpg($(this));' data-tpcn='pg' class='clcheckmostrar' value='SI' $oblcheck  data-currentvalue='$pgta->vacio' name='pg-obligatoria' type='checkbox' data-on='Obligatoria' data-off='Obligatoria?' data-size='small' data-onstyle='success' data-offstyle='default'>
                        </div>
        ...
        <!--<form id='frm-insertupdate' name='frm-insertupdate'   method='post' accept-charset='utf-8'>-->
            ...
            <div class="rpta-radio col-12 ocultar" data-idrp="0" data-delete="0" data-pos="">
                <div class="input-group mb-1">
                  <div class="input-group-prepend">
                    <div class="input-group-text" onclick="clickradio($(this));">
                      <input data-tpcn='rp' class="vw_aep_rptacheck" type="radio">
                    </div>
                  </div>
                  <input data-tpcn='rp' type="text" class="form-control rp-enunciado" >
                  <div class="input-group-append">
                    <a href='#' class='btn btn-default' onclick='delrpta($(this));event.preventDefault();'> <i class='far fa-trash-alt text-danger'></i></a>
                  </div>
                </div>
...
var nfoc=0;
/*$('.card-pregunta.pregunta').focusout(function(event) {
    nfoc++;
    $(this).find('.card-title') .html(nfoc);
});*/
function saveorden(){
...
function savepreg(btn){
    ...
    $.ajax({
        url: base_url + 'cuestionario_general/fn_guarda_pegunta',
        type: 'POST',
        data: fdata,
        dataType: 'json',
        success: function(e) {
