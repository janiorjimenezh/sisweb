            ...
            <div class="card-body px-2 px-sm-3">
                <div class="btable">
                    ...
                    <div class="tbody col-12">
                        ...
                        $btneliminar="<a class='ml-2 text-bold text-danger' onclick='fn_cupb_btn_eliminar_encu($(this));event.preventDefault();'  href='#' data-toggle='tooltip' data-placement='right' title='Eliminar envíos'><i class='fas fa-trash fa-lg'></i></a>";
                        if ($nengeneradas==0){
...
function fn_cupb_btn_eliminar_encu(btn){
    ...
    //row.find('.vwcg_sp_boton').html("<span title='Enviando' class='ml-2 text-bold'><i class='fas fa-spinner fa-pulse'></i></span>");
        $.ajax({
        url: base_url + 'cuestionario_general/fn_eliminar_encuestas_dd_enviadas',
        type: 'POST',
        data: {
            "codencu":codencu,
            "codcg":codcg,
