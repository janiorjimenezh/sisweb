            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item">
                        <a href="<?php echo $vbaseurl.'monitoreo/docentes?tb=e&pd='.$vcodperiodo ?>">Docentes</a>
                    </li>
                    <li class="breadcrumb-item active">Encuesta</li>
                    <li class="breadcrumb-item active">Población</li>
                </ol>
            </div>
        </div>
    </div>
...
if (isset($vcencuesta->codperiodo))  $vcodperiodo=$vcencuesta->codperiodo;
...
<div class="card-body px-2 px-sm-3">
    ...
    <div class="has-float-label row">
        <div class="form-group col-12">
            <input autocomplete="off" value="<?php echo $vnombre ?>" class="form-control" id="vw_cuge_nombre" name="vw_cuge_nombre"  type="text" placeholder="Nombre"   />
...
<div class="card-footer">
    <a href="<?php echo $vbaseurl.'monitoreo/docentes?tb=e&pd='.$vcodperiodo?>" type="button" class="btn btn-secondary" data-dismiss="modal">Cancelar</a>
