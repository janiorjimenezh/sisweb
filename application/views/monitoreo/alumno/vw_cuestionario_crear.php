...
<div class="content-wrapper">
    ...
    <section class="content">
        <form id='frm-insertupdate' name='frm-insertupdate'   method='post' accept-charset='utf-8'>
            <?php 
                $vid="-1";
                if (isset($encuesta->codigo))  $vid=$encuesta->codigo;
             ?>
...
if (isset($encuesta->detalle))  $vcodperiodo=$encuesta->detalle;
if (isset($encuesta->nombre))  $vnombre=$encuesta->nombre;
if (isset($encuesta->descripcion))  $vdescripcion=$encuesta->descripcion;
if (isset($encuesta->detalle))  $vdetalle=$encuesta->detalle;
if (isset($encuesta->tipo))  $vtipo=$encuesta->tipo;
if (isset($encuesta->vence))  $fvence=$encuesta->vence;
if (isset($encuesta->inicia))  $finicia=$encuesta->inicia;
if (isset($encuesta->tiempo))  $vtiempo=$encuesta->tiempo;
if (isset($encuesta->medtiempo))  $vmedtiempo=$encuesta->medtiempo;
if (isset($encuesta->opc1))  $vopcion1=$encuesta->opc1;
if (isset($encuesta->opc2))  $vopcion2=$encuesta->opc2;
if (isset($encuesta->opc3))  $vopcion2=$encuesta->opc3;
if (isset($encuesta->opc4))  $vopcion2=$encuesta->opc4;
                                    ...
                                    <div class="card-body px-2 px-sm-3">
                                        ...
                                        <div class="form-group row">
                                                <div class="col-12 ">
                                                    ...
                                                    <input name="valerta" id="valerta" class="text-center form-control-sm border-top-0 border-right-0 border-left-0" type="number" value="48">
...
<div class="card-footer">
    <button id="vw_cuge_btn-cancel-all" type="button" class="btn btn-secondary" data-dismiss="modal">Cancelar</button>
