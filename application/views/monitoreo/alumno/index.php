			...
			<div class="card-body p-3">
				<div class="tab-content ">
					<div class="active tab-pane" id="tab-academico">
						...
						<div id="hbn_card_boleta">
							
								<div class="row py-2" id="hbn_div_encabezado">
								...
								<table class="table-registro table table-bordered table-striped table-hover table-condensed" id="tr-cursos" role="table">
									<thead role="rowgroup">
										<tr role="row">
											...
											<th role="columnheader">RC</th>
											<th role="columnheader">PF</th>
							...
							<div class="row">
								...
								<div class="col-6 col-md-2">Est = Estado </div>
								<div class="col-6 col-md-2">Ses = N° Sesiones</div>
								<div class="col-6 col-md-2">As = Asistencia</div>
								<div class="col-6 col-md-2">Ft = Faltas</div>
...
<script type="text/javascript" charset="utf-8">
	...
	function searchc(tcar){
		...
		$("#hbn_card_boleta").show();
		/*$('#hbn_div_encabezado').html("");
		$('#hbn_div_boleta').html("");
		$('#hbn_div_boleta').html("");*/
		...
		$.ajax({
				url: base_url + 'monitoreo_alumno/vw_boleta_notas'	,
			type: 'post',
			dataType: 'json',
			...
			success: function(e) {
				...
				if (e.status == false) {
					...
					$('#hbn_div_encabezado').html(e.alumno);
