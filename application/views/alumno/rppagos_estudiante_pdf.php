...
<table class="encabezado celda-lados" cellpadding="0" cellspacing="0" >
	<tr>
		<td class='div_grupo' colspan='4'><b>ESTUDIANTE : </b><?php echo "$carne - $pagante" ?></td>
		<td class='div_grupo' colspan='3'><b>PROGRAMA : </b><?php echo $programa ?> </td>
	</tr>
	...
	<?php
		...
		foreach ($docpagos as $key => $doc) {
			...
			$datemis =  new DateTime($doc->fecha_hora);
			...
			echo "<tr>
					...
					<td class='border-bottom text-small-5 ccenter-nobold' width='100px'>$doc->serie - $doc->numero</td>
					<td class='border-bottom text-small-5 ccenter-nobold' colspan='2'>$emision</td>
					<td class='border-bottom text-small-5 cleft-nobold'>$doc->codgestion $doc->gestion</td>
					<td class='border-bottom text-small-5 ccenter-nobold' >$doc->estadoc</td>
