...
<div class="content-wrapper">
	...
	<div class="modal fade" id="modview_pdf" tabindex="-1" role="dialog" aria-labelledby="modview_pdf" aria-hidden="true" data-backdrop="static" data-keyboard="false">
	...
	<section id="s-cargado" class="content pt-2">
		<div id="divboxhistorial" class="card">
			...
			<div class="card-body">
                ...
                <div class="row mt-2">
                	<div class="col-12">
                		<button class="btn btn-outline-secondary btn-sm float-right ml-2" id="btn_viewfoto">
		...
		<div id="divcard_bandeja" class="card">
			<div class="card-header">
				...
				<div class="card-tools mr-0">
					<button class="btn btn-outline-danger btn-sm" id="btn_deletebandeja">
			...
			<div class="card-body">
				<!-- <div class="row mb-2">
                	<div class="col-12">
                		<button class="btn btn-outline-danger btn-sm float-right" id="btn_deletebandeja">
                			<i class="fas fa-user-minus"></i> Quitar de bandeja
                		</button>
                	</div>
                </div> -->
				<div class="col-12 px-0 pt-2 table-responsive">
                	<table id="tbmt_dtbandeja_Matriculados" class="tbdatatable table table-sm table-hover  table-bordered table-condensed" style="width:100%">
	                  	<thead>
	                      <tr class="bg-lightgray">
	                          <th>N°</th>
	                          <th>Filial</th>
			...
			<div class="card-footer">
				<div class="row mt-2">
                	<div class="col-12">
                		<button class="btn btn-outline-info btn-sm float-right" id="btn_impresion">
	...
	$('#btn_impresion').click(function(e) {
	    ...
	    if (bandejatb > 0) {
	    	...
	    	$("#content_bandeja .cfila_mt").each(function(index) {
	    		...
	    		var myvals_ = [apellidos,nombres,abrevia,ciclo,carnet,turno,periodo,image,codpersona];
