				...
				<div class='div_carne'>
					<table border='0'>
						...
						<tr>
							...
							<td class='text_right td_image divcard_foto' rowspan='6'>
								<b class='text_color_iesap text_right bottom'>$txtcarnet</b>
								<img class='foto_alumno' src='{$vbaseurl}resources/fotos/$rptafoto' alt='foto' style='max-width:113.5px;width:100%;max-height:113.5px;height:100%;'>
							</td>
						</tr>
						<tr>
							<td class='text_left'>
						...
						<tr>
							...
							<td class='text_right'>
								...
								<span class='text_color_content text_emision'><b>$emisioncarne</b></span>
							</td>
						</tr>
					</table>
				</div>
