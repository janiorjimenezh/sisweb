...
<?php
	...
	foreach ($inscritos as $key => $ins) {
		...
		$contenidobar = "#CRT-".$ins->carnet;
		$sigperiodo = (substr($ins->periodo, -1) == "1") ? substr($ins->periodo, 0,5)."2" : $ins->periodo;
		$rptafoto = $ins->foto;
		$existe=comprobarFoto('resources/fotos/' . $ins->foto);
		if ($existe==FALSE)
		{
			$rptafoto = "gg/".$ins->codpersona.".jpg";
			$existe=comprobarFoto('resources/fotos/' . $ins->foto);
			if ($existe==FALSE)
			{
				$rptafoto="user.jpg";
				...
				<div class='div_carne'>
					<table border='0'>
						...
						<tr>
							...
							<td class='text_right td_image' rowspan='6'>
								<b class='text_color_iesap text_right bottom'>$ins->carnet</b>
								<img class='foto_alumno' src='{$vbaseurl}resources/fotos/$rptafoto' alt='foto' style='width:150px;height:130px'>
							</td>
						</tr>
						<tr>
							<td class='text_left'>
								<span class='text_color_content'><b>$ins->nombres</b></span>
							</td>
						...
						<tr>
							<td class='text_left'>
								<span class='text_color_content'><b>$ins->paterno $ins->materno</b></span>
							</td>
						...
						<tr>
							<td class='text_left text_programa'>
								<span class='text_color_content'><b>$ins->carabrevia</b></span>
							</td>
