<div class="col-12 py-1" id="divdata-periodo">
  <div class="btable">
      ...
      <div class="row">
            ...
            <div class='col-12 col-md-5'>
                <div class='row'>
                  ...
                  <div class='col-6 col-md-7 td'>ESTUDIANTE</div>
                  <div class='col-6 col-md-2 td'>SEDE</div>
            ...
            <div class='col-12 col-md-3 text-center'>
                <div class='row'>
                    ...
                    <div class='col-3 col-md-7 td'>
                        <span>ESTADO</span>
                    </div>
                    <div class='col-5 col-md-1 td'>
                        <span></span>
                    </div>
    ...
    <div class="tbody col-12" id="divcard_data_inscritos">
      ...
      ?>
      <div class='row rowcolor cfila' data-tipodoc='<?php echo $usuario->tdoc ?>' data-numero='<?php echo  $usuario->nro ?>'  data-ci="<?php echo $idins ?>" data-cp='<?php echo $usuario->codperiodo ?>' data-cic='<?php echo $ciclo ?>'>
        <div class='col-12 col-md-3'>
          <div class='row'>
            <div class='col-2 col-md-2 td'><?php echo $nro ?></div>
            <div class='col-5 col-md-3 td'><?php echo $usuario->periodo ?></div>
            <div class='col-1 col-md-4 td text-center' title="<?php echo $usuario->carrera ?>"><?php echo $usuario->campania ?></div>
            <div class='col-2 col-md-3 td text-center' title="<?php echo $usuario->carrera ?>"><?php echo "$usuario->carsigla / $usuario->codturno" ?></div>
          </div>
        </div>
        <div class='col-12 col-md-5'>
          <div class='row'>
            ...
            <div class='col-7 col-md-7 td'>
             ...
             <div class='col-7 col-md-2 td'>
              
              <span class="cell-sede"><?php echo $usuario->sede ?></span>
            </div>
            ...
            <div class='col-8 col-md-4 td'>
                  ...
                  <?php 
                    if ($usuario->estado=="RETIRADO"){
                      echo "<a class='bg-primary d-block tboton' href='".base_url()."admision/reingresos?sb=admision&fcarnet=$usuario->carnet' title='Reingresos'>
                        Reingresos
                      </a>";
                    }
                    else{
                      echo "<a class='bg-primary d-block tboton' href='".base_url()."admision/inscripciones?sb=admision&fcarnet=$usuario->carnet' title='Inscripciones'>
                        Inscripciones
                      </a>";
                    }
                  ?>
                  <!--<div class='btn-group'>
                    ...
                    <div class='dropdown-menu dropdown-menu-right acc_dropdown'>
                        ...
                        <a class='dropdown-item btn-anexados' href='#' title='Documentos Anexados' data-ci="<?php echo $idins ?>" data-toggle="modal" data-target="#modal-docporanexar">
