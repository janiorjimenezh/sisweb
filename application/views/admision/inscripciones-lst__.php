                ...
                <div class="col-6 col-md-6">
                  <div class='btn-group'>
                    ...
                    <div class='dropdown-menu dropdown-menu-right acc_dropdown'>
                        ...
                        <a class='dropdown-item btn-anexados' href='#' title='Enviar mensaje' data-ci="<?php echo $idins ?>" data-emailper="<?php echo $usuario->epersonal ?>" data-carnet="<?php echo $usuario->carnet ?>" data-toggle="modal" data-target="#modal-sendemail">
