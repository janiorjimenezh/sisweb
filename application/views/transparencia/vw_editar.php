        ...
        <div id="vw_pw_bt_ad_div_principal" class="card">
            <div class="card-body">
                <form id="vw_pw_bt_ad_form_addDWeb" action="<?php echo $vbaseurl ?>bolsa/fn_insert_datos" method="post" accept-charset="utf-8">
                    <div class="row mt-2">
                        <input id="vw_pw_bt_ad_fictxttipo" name="vw_pw_bt_ad_fictxttipo" type="hidden" value="<?php echo base64url_encode('TP') ?>">
                        ...
                        <div class="form-group has-float-label col-12 col-sm-8">
                            <select name="vw_pw_bt_ad_cbotiposp" id="vw_pw_bt_ad_cbotiposp" class="form-control">
                                ...
                                <option value="DOCUMENTOS DE GESTIÓN INSTITUCIONAL">DOCUMENTOS DE GESTIÓN INSTITUCIONAL</option>
                                <option value="RESOLUCIONES DIRECTORALES">RESOLUCIONES DIRECTORALES</option>
                            </select>
                            <label for="vw_pw_bt_ad_cbotiposp">Categoria</label>
                        </div>
                        <div class="form-group has-float-label col-12 col-sm-4">
                            <input data-currentvalue='' autocomplete="off" class="form-control" id="vw_pw_bt_ad_fictxtorden" name="vw_pw_bt_ad_fictxtorden" type="text" placeholder="N° Orden" />
                        ...
                        <div class="col-12 px-3 text-center">
                            ...
                            <h5> Arrastra aquí tus archivos (1 archivo máx. - Peso 5 MB máx. c/u)</h5>
                        ...
                        <div class="col-12">
                            ...
                            <button type="submit" id="vw_pw_bt_ad_btn_guardar" class="btn btn-primary btn-md float-right"><i class="fas fa-save"></i> Registrar</button>
                        </div>
                    </div>
                </form>
            </div>
...
$("#vw_pw_bt_ad_btn_guardar").click(function(event) {
    ...
    $.ajax({
        url: base_url + 'transparencia/fn_insert',
        type: 'POST',
        data: fdata,
        dataType: 'json',
        success: function(e) {
