		    ...
		    <div class="card-header">
		    	...
		    	<div class="col-6 col-sm-3 col-md-3 card-tools no-padding">
                  	<form id="form_status" action="<?php $vbaseurl ?>" method="post" accept-charset="utf-8">
                  		<input type="hidden" name="txtcodigoinc" id="txtcodigoinc" value="<?php echo $detalle->id ?>">
                  		<div class="form-group has-float-label col-lg-12 col-md-12 col-sm-12">
				        	<select name="txtstatus" id="txtstatus" class="form-control">
				        		<option <?php echo ($detalle->estado == 'ENVIADO') ? 'selected' : '' ?> value="ENVIADO">ENVIADO</option>
				        		<option <?php echo ($detalle->estado == 'REVISION') ? 'selected' : '' ?> value="REVISION">REVISION</option>
				        		<option <?php echo ($detalle->estado == 'CERRADO') ? 'selected' : '' ?> value="CERRADO">CERRADO</option>
				        	</select>
	      			...
	      			<div class="row">
	      				...
	      				<div class="col-6 col-lg-4">
	      					<div class="info-box">
	      						<div class="info-box-content">
			                  		<h5>Documento</h5>
			                  		<p><?php echo $detalle->documento ?></p>
			                  	</div>
			                </div>
	      				</div>
	      				<div class="col-6 col-lg-4">
	      					<div class="info-box">
	      						<div class="info-box-content">
			                  		<h5>Domicilio</h5>
			                  		<p><?php echo $detalle->domicilio ?></p>
			                  	</div>
			                </div>
	      				</div>
	      				<div class="col-6 col-lg-4">
		      			...
		      			?>
		      					<div  class="row cfila <?php echo ($nro % 2==0) ? 'bg-lightgray':'' ?>">
									<div class="col-12 col-md-12 group">
										...
										<div class="col-2 col-md-2 cell text-center">
											<span>
												<a class="btn-delete bg-success py-1 px-3 rounded" target="_blank" href="<?php echo base_url()."upload/tramites/".$prb->link ?>" title="Descargar">
	      		...
	      		<div class="row d-none" id="divcontent_reply">
	      			<div class="col-lg-12">
		      			<form id="form_reply" action="<?php echo $vbaseurl ?>sendmail/f_enviar_respuesta" method="post" accept-charset="utf-8">
		      				<input type="hidden" name="txtiduser" id="txtiduser" value="<?php echo $detalle->usuario ?>">
		      				<input type="hidden" name="txtincidencia" id="txtincidencia" value="<?php echo $detalle->id ?>">
		      				<div class="row">
		      					<div class="col-lg-12">
