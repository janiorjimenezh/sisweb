	...
	<section id="s-cargado" class="content pt-2">
		<div id="divboxhistorial" class="card">
			<div class="card-header">
				<h3 class="card-title"><i class="fas fa-list mr-1"></i> INCIDENCIA</h3>
			</div>
			<div class="card-body">
				<form id="frm-add-incidencia" action="<?php echo $vbaseurl ?>incidencia/fn_insert_propio" method="post" accept-charset="utf-8">
					<section>
						...
						<div class="row">
							<div class="form-group has-float-label col-lg-3 col-md-6 col-sm-6">
								<input class="form-control form-control-sm" type="text" placeholder="Tipo Doc" name="vw_ric_txt_tipodoc" id="vw_ric_txt_tipodoc" value="<?php echo $_SESSION['userActivo']->tipodoc ?>">
								<label for="vw_ric_txt_tipodoc">Tipo Doc</label>
							</div>
							<div class="form-group has-float-label col-lg-3 col-md-6 col-sm-6">
								<input class="form-control form-control-sm" type="text" placeholder="DNI" name="vw_ric_txt_nrodoc" id="vw_ric_txt_nrodoc"  value="<?php echo $_SESSION['userActivo']->nrodoc ?>">
								<label for="vw_ric_txt_nrodoc">DNI</label>
							</div>
							<div class="form-group has-float-label col-lg-6 col-md-6 col-sm-6">
								<input class="form-control form-control-sm" type="text" placeholder="Apellidos y nombres" name="vw_ric_txt_apenombres" id="vw_ric_txt_apenombres" value="<?php echo $_SESSION['userActivo']->paterno.' '.$_SESSION['userActivo']->materno.' '.$_SESSION['userActivo']->nombres ?>">
								<label for="vw_ric_txt_apenombres">Apellidos y nombres</label>
							</div>
							
							<div class="form-group has-float-label col-lg-6 col-md-6 col-sm-6">
								<input class="form-control form-control-sm" type="text" placeholder="Domicilio" name="vw_ric_txt_domicilio" id="vw_ric_txt_domicilio">
								<label for="vw_ric_txt_domicilio">Domicilio</label>
							</div>
							<div class="form-group has-float-label col-lg-6 col-md-6 col-sm-6">
								<input class="form-control form-control-sm" type="text" placeholder="Distrito" name="vw_ric_txt_distrito" id="vw_ric_txt_distrito">
					...
					<section>
						...
						<span class="text-help">Me presento con la finalidad de dejar constancia de una incidencia contra:</span>
						<div class="row mt-2">
							<div class="form-group has-float-label col-lg-8 col-md-6 col-sm-6">
								<input class="form-control form-control-sm" type="text" placeholder="Denunciado" name="vw_ric_txt_denunciado" id="vw_ric_txt_denunciado">
								<label for="vw_ric_txt_denunciado">Denunciado</label>
							</div>
							<div class="form-group has-float-label col-lg-4 col-md-6 col-sm-6">
								<input class="form-control form-control-sm" type="text" placeholder="Cargo" name="vw_ric_txt_cargo" id="vw_ric_txt_cargo">
						...
						<div class="row">
							...
							<div class="form-group col-lg-12 col-md-12 col-sm-12">
								...
								<!-- <label for="txtdetalle">Detalle Incidencia</label> -->
							</div>
						</div>
						<div class="row">
							<div class="col-12">
							...
							<div class="form-group has-float-label col-12 ">
								<input class="form-control" type="text" placeholder="Nombre" name="vw_ric_txt_custodio" id="vw_ric_txt_custodio">
								<label for="vw_ric_txt_custodio">Nombre</label>
							</div>
					...
					<section>
						...
						<div class="row">
							<div class="form-group col-lg-12">
								...
								<div class="row">
									<b>(Se permite hasta 10 archivos con un máximo de 10 Mb por cada uno) <br>
									* Solo se permiten los siguientes tipos de archivo: pdf,doc,docx,xls,xlsx,ppt,pptx,jpg,jpeg,xml,txt,xple.</b>
								</div>
							</div>
...
$('#vw_mpc_file').change(function(){
    ...
    $('#vw_mpc_txt_filename').html(filename);
	    ...
	    $.ajax({
	        ...
	        success: function(e) {
	            ...
	            if (e.status == false) {
	                ...
	                var codigo = e.codigo;
	                $.ajax({
	                    url: base_url + 'sendmail/f_enviar_confirmacion',
	                    type: 'post',
	                    dataType: 'json',
	                    data: {
	                        txtemail: user,
	                    ...
	                    success: function(e) {
	                        ...
	                        if (e.status == true) {
	                            ...
	                            $("#frm-add-incidencia").addClass('d-none');
