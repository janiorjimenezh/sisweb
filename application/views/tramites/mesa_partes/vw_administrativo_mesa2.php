            ...
            <div class="col-12">
              <div class="form-group row">
                ...
                <select class="form-control col-md-5 form-control-sm" name="vw_mpae_cb_ejecutar" id="vw_mpae_cb_ejecutar">
                  ...
                  <?php if (getPermitido("68")=="SI") echo "<option value='FINALIZADO'>FINALIZAR</option>" ?>
                </select>
              </div>
    ...
    <div id="divcard-general" class="card">
      <div class="card-header ">
        ...
        <div class="row">
          ...
          <div class="form-check form-check-inline">
            <input class="form-check-input" type="radio" id="rbfinalizado" name="rbsituacion" value="FINALIZADO">
            <label class="form-check-label" for="rbfinalizado">Finalizado</label>
          </div>
        </div>
        <div class="row mt-3">
            ...
            <div class="row">
              <div class='col-12 col-md-4'>
                <div class='row'>
                  ...
                  <div class='col-5 col-md-5 td text-center'>INGRESÓ</div>
                  <div class='col-5 col-md-5 td text-center'>SOLICITANTE</div>
                </div>
              </div>
            ...
            "<div class='row rowcolor'>
              <div class='col-12 col-md-4'>
                <div class='row'>
                  ...
                  <div class='col-10 col-md-5 td text-center'>
              ...
              <div class='col-10 col-md-2 td text-center'>
                    $bfOrigen
              </div>
              ...
              <div class='col-12 col-md-1 td text-center'>
                <button type='button' data-seguimiento='$cod64'  class='btn btn-warning vw_mpa_lista_btn_ver_ruta'><i class='fas fa-search'></i></button>
              </div>
