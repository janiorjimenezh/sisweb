        ...
        <form id="frm-add-mesa" action="<?php echo $vbaseurl ?>mesa_partes/fn_insert" method="post" accept-charset="utf-8">
          <div class="row">
            ...
            <?php if (getPermitido("68")=="SI"): ?>
              <div class="form-check col-md-5 text-center">
                <input data-coduser='' data-apelnom='' data-tipodoc='' data-numero='' data-domicilio='' data-telefono='' data-correo='' class="form-check-input" type="checkbox" id="inlineCheckbox1" value="option1">
                <label class="form-check-label" for="inlineCheckbox1">Documento Propio</label>
              </div>
            <?php endif ?>
          ...
          <section>
            ...
            <div class="row">
              <div class="col-12">
                <div class="row">
                  ...
                  <select class="form-control col-md-10 form-control-sm" name="vw_mp_cb_situacion" id="vw_mp_cb_situacion">
                    ...
                    <option data-msg="" <?php echo (!isset($insc->carne)) ? "selected" : ""; ?> value="Otros">Otros</option>  
                  </select>
                </div>
              </div>
              <div class="form-group col-md-4">
              ...
              <div class="col-md-4">
                <div class="row">
                  ...
                  <select class="form-control col-md-6 form-control-sm" name="vw_mp_cb_tdoc" id="vw_mp_cb_tdoc">
                    <?php 
                      echo 
                     "<option ".(($userActivo->tipodoc=='DNI')?'selected':'')." value='DNI'>DNI</option>
                      <option ".(($userActivo->tipodoc=='CEX')?'selected':'')." value='CEX'>Carné de Extranjería</option>
                      <option ".(($userActivo->tipodoc=='PSP')?'selected':'')." value='PSP'>Pasaporte</option>
                      <option ".(($userActivo->tipodoc=='PTP')?'selected':'')." value='PTP'>Permiso Temporal de Permanencia</option>
                      <option ".(($userActivo->tipodoc=='RUC')?'selected':'')." value='RUC'>RUC</option> ";
              ...
              <div class="col-md-4">
                <div class="row">
                  ...
                  <input id="vw_mp_txt_nro_doc" name="vw_mp_txt_nro_doc" type="text" class="form-control col-md-7 form-control-sm" maxlength="200" minlength="5" value="<?php echo $userActivo->nrodoc ?>">
              ...
              <div class="col-md-5">
                <div class="row">
                  ...
                  <select class="form-control col-md-8 form-control-sm" name="vw_mp_txt_programa" id="vw_mp_txt_programa">
                    <?php echo "<option value='$insc->idcarrera'>$insc->carrera</option>" ?>
                  </select>
                </div>
              </div>
            ...
            <div class="row">
              ...
              value='<?php echo $userActivo->paterno.' '.$userActivo->materno.' '.$userActivo->nombres ?>'>
            </div>
            ...
            <div class="row">
              ...
              <input autocomplete="off" value="<?php echo $perfil->domicilio ?>" id="vw_mp_txt_domicilio" name="vw_mp_txt_domicilio" type="text" class="form-control col-md-10 form-control-sm" maxlength="200" minlength="5">
            </div>
            <div class="row">
              ...
              <input autocomplete="off" id="vw_mp_txt_email" name="vw_mp_txt_email" type="text" class="form-control col-md-5 form-control-sm" maxlength="200" minlength="5" value="<?php echo $perfil->epersonal ?>">
            ...
            <div class="row">
              ...
              <input autocomplete="off" id="vw_mp_txt_email_corporativo" name="vw_mp_txt_email_corporativo" type="text" class="form-control col-md-5 form-control-sm" maxlength="200" minlength="5" value="<?php echo $perfil->ecorporativo ?>">
            ...
            <div class="row">
              ...
              <input autocomplete="off" value="<?php echo $perfil->celular ?>" id="vw_mp_txt_celular" name="vw_mp_txt_celular" type="text" class="form-control col-md-10 form-control-sm" maxlength="200" minlength="5">
            </div>
    ...
    $.ajax({
        ...
        success: function(e) {
            ...
            if (e.status == false) {
              ...
              //     "<h3 class='text-success'>" + e.msg + "</h3>"+
              //   "</div><div class='col-8 col-md-5'>"+
              //     "<h4>CÓDIGO DE SEGUMIENTO</h4>" +
              //   "</div><div class='col-4 col-md-2'>"+
              //     "<h3 class='text-primary'>" + e.codseg + "</h3>"+
              //   "</div></div>");
              $("#divcard_msg").html(e.msg);
