        ...
        <form id="frm-add-mesa" action="<?php echo $vbaseurl ?>mesa_partes/fn_insert" method="post" accept-charset="utf-8">
          ...
          <section class="border mx-n2 mt-3 p-3">
            ...
            <div class="form-group">
              ...
              <div class=" col-md-12 border rounde py-2" style="min-height: 120px">
          ...
          <section class="border mx-n2 p-3">
            <div class="row mt-3">
              <div class="col-12">
                <?php 
                echo 
                "<a type='button' href='{$vbaseurl}tramites/mesa-de-partes' class='btn btn-outline-danger btn-md float-left' ><i class='fas fa-undo'></i> Volver</a>
