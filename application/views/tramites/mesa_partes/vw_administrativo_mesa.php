...
<div class="content-wrapper">
  <div id="vw_mpr_md_verdatos" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" data-backdrop="static">
...
function pagination_mesa(cantidad,total=1){
  var pagtotal = Math.ceil(cantidad / 40);
    $('#page-selection').html('');
    if (pagtotal > 0) {
