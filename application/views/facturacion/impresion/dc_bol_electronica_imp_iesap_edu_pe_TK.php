...
<table class="encabezado">
	<tr>
		<td class="ccenter-nobold" colspan="4">
			<img class="logo-ies2" src="<?php echo base_url().'resources/img/logo_facturacion.'.getDominio().'.png' ?>" alt="Logo de Facturación">
		</td>
	</tr>
	<tr>
		<td class="ccenter-nobold padding-top" colspan="4">
			
			<b class="text-small-8 ">INVERSIONES EDUCATIVAS IESCOOP SAC</b>
		</td>
	</tr>
	<tr>
		<td class="ccenter-nobold " colspan="4">
...
<table class="encabezado">
	...
	<tr>
		...
		<td>
			<span class="text-small-5"><?php echo "{$pag->ptipodoc}: $pag->pnrodoc 
			$pag->pagantenom <br>
			 

	<span class='text-small-5' >Dirección: $pag->direccion </span><br>
			MONEDA: soles<br>
			IGV: {$pag->igv}%" ?></span>
		</td>
...
<div class="div_nota mb">
	...
	<table class="text-small-4" cellpadding="0"  width="100%">
		<tr>
			...
			<td colspan="2">....................................................................
			 <br><b>DOCUMENTO QUE MODIFICA</b></td>
		</tr>
		...
		<tr>
			...
			<td colspan="2"><b>Sustento</b>: <?php echo $pag->motivo ?></td>
