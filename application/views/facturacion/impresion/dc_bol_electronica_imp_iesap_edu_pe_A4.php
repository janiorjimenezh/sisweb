...
<div class="div_logo">
	...
	<b class="text-small-5 ">INVERSIONES EDUCATIVAS IESCOOP SAC</b><br>
	<?php echo "
...
<table class="encabezado celda-lados" cellpadding="0" cellspacing="0" >
	...
	<tr>
		<td colspan="3" rowspan="5" class="border-top">
			<?php if ($pag->condicion=="CRÉDITO"): ?>
				<table class="encabezado celda-lados" cellpadding="0" cellspacing="0" >

					<tr>
						<td rowspan="5" align="center"><b>CRÉDITO: </b></td>
						<td align="center"><b>Cuota</b></td>
						<td align="center"><b>Vence</b></td>
						<td align="right"><b>Monto</b></td>
					</tr>
					<?php 
						foreach ($cuotas as $key => $ct) {
							$dvc =  new DateTime($ct->fecha) ;
							$vc= date($dvc->format('d/m/Y'));
							echo "<tr>
									<td align='center'>$ct->ncuota</td>
									<td align='center'>$vc</td>
									<td align='right'>".number_format($ct->monto, 2, '.', '')."</td>
								</tr>";
						} 
					 ?>
				</table>
