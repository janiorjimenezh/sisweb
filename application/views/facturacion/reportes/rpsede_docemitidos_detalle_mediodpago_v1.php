...
<table class="encabezado celda-lados" cellpadding="0" cellspacing="0" >
	<tr>
		...
		<td class="border-bottom text-small-5 cleft-nobold">MEDIO DE PAGO</td>
...
<table class="encabezado celda-lados" cellpadding="0" cellspacing="0" >
	...
	<tr>
		...
		<td class="border-bottom text-small-5 cleft-nobold" width="250px"><?php echo $mat->pagante ?></td>
		<?php 
		$vmedios="";
		$vvaucher="";
		$vmonto="";
		...
		?>
		<td class="border-bottom text-small-5 cleft-nobold"><?php echo $vmedios ?></td>
		<td class="border-bottom text-small-5 cleft-nobold"><?php echo $vvaucher ?></td>
		<td class="border-bottom text-small-5 cleft-nobold" align="right"><?php echo $vmonto ?></td>
