...
<table class="encabezado celda-lados" cellpadding="0" cellspacing="0" >
	<tr>
		...
		<td class="ccenter-nobold bg-detalle" width="70px"><b>COD.DEUDA</b></td>
	</tr>
</table>
</div>
...
<table class="encabezado celda-lados" cellpadding="0" cellspacing="0" >
	...
	<tr>
		...
		<td width="50px" class="border-bottom text-small-5 cleft-nobold"><?php echo $mat->pagantenrodoc ?></td>
		<td class="border-bottom text-small-5 cleft-nobold" width="160px"><?php echo $mat->pagante ?></td>
		...
		<td class="border-bottom text-small-5 ccenter-nobold" width="70px"><?php echo $mat->coddeuda ?></td>
	</tr>
	<?php 
