...
<div class="content-wrapper">
  	<section id="s-cargado" class="content pt-2">
    	<div id="divcard_slide" class="card">
			...
			<div class="card-body">
              	<form id="frm_updateslider" name="frm_updateslider" action="<?php echo base_url() ?>slider/fn_insert_update" method="post" accept-charset='utf-8'>
                	<input id="fictxtaccion" name="fictxtaccion" type="hidden" value="EDITAR">
                	<input id="fictxtidslide" name="fictxtidslide" type="hidden" value="<?php echo base64url_encode($slider->id) ?>">
					...
					<div class="row mt-2">
						<div class="form-group has-float-label col-12 col-sm-8">
							<input type="hidden" name="fictxtimageexist" id="fictxtimageexist" value="<?php echo $slider->imagen ?>">
						...
						<div class="form-group col-md-4">
							...
							<input  id="checkestado" <?php echo ($slider->activo == "SI")?"checked":"" ?> name="checkestado" data-size="sm" type="checkbox" data-toggle="toggle" data-on="SI" data-off="NO" data-onstyle="success" data-offstyle="danger">
						</div>
					</div>
					<div class="row">
						<div class="col-md-12 mb-3">
							<div class="my-3">
								<img class="previsualizarslide bg-light" src="<?php echo base_url() ?>upload/slider/<?php echo $slider->imagen ?>" style="width: 350px;height: auto;">
							</div>
						</div>
					</div>
					<div class="row">
...
<script type="text/javascript">
	...
	$('#fictxtimagen').change(function(){
		...
		if (this.files.length != 0) {
			...
			$(".previsualizarslide").attr("src", "<?php echo $vbaseurl.'upload/slider/'.$slider->imagen ?>");
