    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content modEnrolados_content">
            ...
            <div class="modal-body">
                <div id="divMdoalCronogramaDetalle" class="col-12">
                    <div class="row">
                        <div class="col-md-6">
            ...
            <div class="modal-footer">
                <a href="#" class="btn btn-primary text-bold mr-1" onclick='fn_vw_agregar_grupo($(this));return false'>
                    <i class="fas fa-users mr-1"></i> Agregar Grupo
                </a>
                <a href="#" class="btn btn-primary text-bold mr-2" data-accion="nuevo" onclick='fn_vw_agregar_fecha($(this));return false'>
                    <i class="fas fa-users mr-1"></i> Agregar Fecha
                </a>
...
<script type="text/javascript">
    ...
    function vw_abrir_modal_cronogramaDetalle(boton){
        ...
        $('#divMdoalCronogramaDetalle').append('<div id="divoverlay" class="overlay  d-flex justify-content-center align-items-center">'  + getCargando("Un momento...") + '</div>');
        ...
        $.each(vfechas, function(index, val) {
            ...
            vnombre=    "<div class='col-8'>" +
                        ...
                        "<div class='col-4 text-center'>" + 
                            "<a title='Agregar Item de pago' class='badge badge-primary mx-1 px-1 text-white' href='#' data-toggle='modal' data-target='#modMantCalendario' data-accion='Nuevo'><i class='fas fa-plus-square mr-1'></i> Item =>" +
                            "</a>" +
                        "</div>" ;
    ...
    function vw_abrir_modal_proyectarMatriculas(boton){
        $('#divModalProyectarMatriculas').append('<div id="divoverlay" class="overlay  d-flex justify-content-center align-items-center">'  + getCargando("Un momento...") + '</div>');
