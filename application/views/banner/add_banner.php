...
<div class="content-wrapper">
  	<section id="s-cargado" class="content pt-2">
    	<div id="divcard_slide" class="card">
			...
			<div class="card-body">
              	<form id="frm_addslider" name="frm_addslider" action="<?php echo $vbaseurl ?>banner/fn_insert_update" method="post" accept-charset='utf-8'>
                	...
                	<div class="row">
                  		<div class="form-group has-float-label col-12 col-sm-12 col-md-12">
                    		<input class="form-control" id="fictitulo" name="fictitulo" type="text" placeholder="Titulo" minlength="3" maxlength="150" />
                    		<label for="fictitulo"> Titulo Banner</label>
                  		</div>
                	</div>
                	<div class="row">
                		<div class="form-group has-float-label col-12 col-sm-12 col-md-12">
                			<textarea name="fictxtdesc" id="fictxtdesc" class="form-control" placeholder="descripción" rows="4" maxlength="300"></textarea>
                			<label for="fictxtdesc"> Descripción (opcional) </label>
                		</div>
                	</div>
                	<div class="row">
                		<div class="form-group has-float-label col-12 col-sm-12 col-md-12">
                    		<input class="form-control" id="ficurlboton" name="ficurlboton" type="text" placeholder="Url" minlength="3" />
                    		<label for="ficurlboton"> Url </label>
                  		</div>
                		<div class="col-md-4">
                  			<span><b>Mostrar link como boton</b></span>
                  			<div class="form-group mt-2">
								<input  id="checkboton" name="checkboton" data-size="sm" type="checkbox" data-toggle="toggle" data-on="SI" data-off="NO" data-onstyle="success" data-offstyle="danger">
							</div>
                  		</div>
                	</div>
                	<div class="row d-none" id="divboton">
                		<div class="form-group has-float-label col-12 col-sm-12 col-md-12">
                    		<input class="form-control" id="fictextboton" name="fictextboton" type="text" placeholder="texto en boton" minlength="3" />
					...
					<div class="row">
						...
						<div class="col-12">
                            <a type="button" href="<?php echo $vbaseurl ?>portal-web/banner" class="btn btn-danger btn-md float-left" >
