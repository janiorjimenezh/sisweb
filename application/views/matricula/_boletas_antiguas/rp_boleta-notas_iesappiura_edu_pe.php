...
<table class="tabla-sm" border="0">
	<tr>
		<td style="width: 20px;" align="center" class="p-0">
			<img class="logo-ies" src="<?php echo base_url().'resources/img/logo_h110.iesappiura.edu.pe.jpg' ?>" alt="IESTP">
			<h3><b style="font-size: 20px;color: #ac1a25;">IESAP</b></h3>
		</td>
...
<table class="encabezado">
	...
	<tr>
		...
		<!-- <td class="texto">
			<span><b><?php //echo strtoupper($mat->ciclo)." ".$mat->codseccion ?></b></span>
		</td> -->
		<td class="texto <?php echo $colorbg ?>">
			<span>TURNO:</span> <span><b><?php echo strtoupper($mat->turno) ?></b></span>
		</td>
		<!-- <td class="texto">
			<span><b><?php //echo strtoupper($mat->turno) ?></b></span>
		</td> -->
	</tr>
</table>
...
<table class="encabezado">
	...
	<tr>
		...
		<?php }
			...
			<td class="celda ccenter-nobold">
				<span><?php echo ($cur->recuperacion==0) ? "" : $cur->recuperacion; ?></span>
			</td>
			<td class="celda ccenter-nobold">
				<span><?php echo $cur->final ?></span>
			</td>
			<td class="celda ccenter-nobold">
				<span><?php echo $unidades[$cur->final] ?></span>
			</td>
		<?php } ?>
