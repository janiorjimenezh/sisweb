...
<watermarkimage src="<?php echo base_url().'resources/img/logo_h110.iesap.edu.pe.png' ?>" alpha="0.1" position="50,70"  size="D" />
<table class="tabla-sm" border="0">
	<tr>
		<td style="width: 20px;" align="center" class="p-0">
			<img class="logo-ies" src="<?php echo base_url().'resources/img/logo_h110.iesap.edu.pe.png' ?>" alt="IESTP">
...
<table class="encabezado">
	...
	<tr>
		...
		<td class="texto <?php echo $colorbg ?>">
			<span>SEMESTRE:</span> <span><b><?php echo strtoupper($mat->ciclo) ?></b></span>
		</td>
...
<table class="encabezado">
	...
	<tr>
		...
		<?php }
			...
			<td class="celda ccenter-nobold">
				<span><?php echo (isset($unidades[$vfinal])? $unidades[$vfinal]: "--") ?></span>
			</td>
		<?php } ?>
