            ...
            <div class="modal-dialog modal-xl modal-dialog-scrollable" role="document">
                <div class="modal-content" id="md_en_content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-8" id="vw_detalle_tarea">
                                <div class="row">
                            ...
                            <div class="col-md-4" id="form_nota_tarea">
                                <div class="form-group row">
                                    <label for="md_en_nota" class="col-md-3 col-form-label">Nota:</label>
                                    <div class="col-md-9">
                        ...
                        <div id="div-filtro" class="tbody col-12">
                            ...
                            <div data-centrega="" class="row rowcolor" data-nota="<?php echo $cdnota ?>" data-miembro="<?php echo $cdmiembro ?>" data-entrega="<?php echo $cdcodentrega ?>">
                                ...
                                <div class="col-12 col-md-5">
                                    <div class="row">
                                        <div class=" col-8 col-md-9 td vw_vte_div_archivos">
                                            <?php echo $cdfecentrega ?> 
                                            <div class="text-danger"><?php echo $cdarchivos ?></div>
                                        </div>
                                        <div class="col-4 col-md-3 td text-left">

                                            <a href="#"  data-detalle='' class="tboton bg-primary vw_vte_btn-verentrega" data-tipo="nota">
                                               <?php echo $cdnota ?> <i class="fas fa-pencil-alt ml-1"></i>
                                            </a>

                                            <?php if (strip_tags(trim($trdetalle)) !== "") {
                                                echo "<a href='#' title='comentario' class='tboton bg-primary vw_vte_btn-verentrega ml-1' data-tipo='comentario'>
...
<script>
    ...
    $('.vw_vte_btn-verentrega').click(function(event) {
        ...
        ajcodentrega=row.data('entrega');
        detalle="";
        fila=row;
        obs=row.find('.cobservacion').html();
        nota=row.data('nota');
        ajcodmiembro=row.data('miembro');
        ajcodtarea = '<?php echo $codmaterial64 ?>';
        ajcodcarga = '<?php echo $codcarga64 ?>';
        ajcoddivision = '<?php echo $division64 ?>';
        modtipo = $(this).data('tipo');
        $('#md_en_content').append('<div id="divoverlay" class="overlay bg-white d-flex justify-content-center align-items-center"><i class="fas fa-spinner fa-pulse fa-3x"></i></div>');
        $.ajax({
            url: base_url + 'virtualtarea/fn_get_tarea_entregada',
            type: 'POST',
            data: {
                "ajcodmiembro":ajcodmiembro,
                "ajcodentrega": ajcodtarea,
            ...
            success: function(e) {
                ...
                if (modtipo !=="nota") {
                    $('#form_nota_tarea').hide();
                    $('#md_ent_btn-calificar').hide();
                    $('#vw_detalle_tarea').removeClass('col-md-8');
                    $('#vw_detalle_tarea').addClass('col-md-12');
                } else {
                    $('#form_nota_tarea').show();
                    $('#md_ent_btn-calificar').show();
                    $('#vw_detalle_tarea').removeClass('col-md-12');
                    $('#vw_detalle_tarea').addClass('col-md-8');
    ...
    $(document).on('click', '.vw_content_file', function(e) {
        ...
        var estudiante = fila.find('.calumno').html();
        ...
        $('#md_rpta_documents #mv_title_estudiante').html(estudiante);
