                ...
                <div class="card-body px-0 px-sm-3">
                    ...
                    <div class="row p-2 rowcolor">
                        <div class="col-6 col-md-3">
                            <span><a class="badge badge-pill badge-info" tabindex="0" data-toggle="popover" data-trigger="focus" title="Fecha límite" data-content="Nro de alumnos enrolados al curso"> ? </a> N° de alumnos: </span>
                        </div>
                     ...
                     <div class="row p-2 rowcolor">
                        <div class="col-6 col-md-3">
                            <span><a class="badge badge-pill badge-info" tabindex="0" data-toggle="popover" data-trigger="focus" title="Inicia" data-content="Fecha y hora que inicia la evaluación"> ? </a> Inicia: </span>
                        </div>
                        <div class="col-6 col-md-4">
                            <span><?php echo "$fechav $horai" ?></span>
                        </div>
                    </div>
                    <div class="row p-2 rowcolor">
                        <div class="col-6 col-md-3">
                            <span><a class="badge badge-pill badge-info" tabindex="0" data-toggle="popover" data-trigger="focus" title="Finaliza" data-content="Fecha y hora limite para la entrega de la evaluación"> ? </a> Finaliza: </span>
                        </div>
                        <div class="col-6 col-md-4">
                    ...
                    <div class="row p-2 rowcolor">
                        <div class="col-6 col-md-3">
                            <span><a class="badge badge-pill badge-info" tabindex="0" data-toggle="popover" data-trigger="focus" title="Hora límite" data-content="Cantidad de archivos que puedes enviar">? </a> Duración:</span>
                        </div>
                        <div class="col-6 col-md-4">
                            <span><?php 
                            $tmedida[0]="";
