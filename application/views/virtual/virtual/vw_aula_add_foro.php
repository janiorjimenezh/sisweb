            ...
            <div class="card border-light">
                ...
                <?php 
                    ...
                    if ($finicia!=""){
                        ...
                        $horai = date('H:i:s',strtotime($finicia)); 
                        $checi="checked";
                        $enabledi="";
                    }
                    $fechav= date('Y-m-d');;
                    ...
                    if ($fvence!=""){
                        ...
                        $horav = date('H:i:s',strtotime($fvence)); 
                        $checv="checked";
                        $enabledv="";
                    }
                    $tiempol = 0;
                ...
                <div class="card-body px-3">
                    <div class="row">
                        ...
                        <div class="col-3">
                            <input id="txtopenfecha" name="txtopenfecha" class="inputstiempo form-control" type="date" placeholder="Fecha límite" autocomplete="off" required value="<?php echo $fechai ?>"  <?php echo $enabledi ?>/>
                        </div>
                        <div class="col-3">
                            <input id="txtopenhora" name="txtopenhora" class="inputstiempo form-control" type="time" placeholder="Hora límite" autocomplete="off" required value="<?php echo $horai ?>"  <?php echo $enabledi ?>/>
                        </div>
                        <div class="col-2 pt-2">
                    ...
                    <div class="row pt-2">
                        ...
                        <div class="col-3">
                            <input id="txtclosefecha" name="txtclosefecha" class="inputstiempo form-control" type="date" placeholder="Fecha límite" autocomplete="off" required value="<?php echo $fechav ?>"  <?php echo $enabledv ?>/>
                        </div>
                        <div class="col-3">
                            <input id="txtclosehora" name="txtclosehora" class="inputstiempo form-control" type="time" placeholder="Hora límite" autocomplete="off" required value="<?php echo $horav ?>"  <?php echo $enabledv ?>/>
                        </div>
                        <div class="col-2 pt-2">
                ...
                <div class="card-header px-3">
                    <div class="row">
                        <div class="col-12">
                            ...
                            <label for="checkopcion1"> El participante debe agregar su opinión para poder ver los comentarios de los demas</label>
