                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-12 col-md-6">
                                ...
                                <div class="brcheck">
                                    <input data-texto="Tarea" data-msj="Las tareas permite al docente asignar trabajos encargados, ademas los alumnos pueden presentar cualquier contenido digital, como documentos de texto, hojas de cálculo, imágenes, audio y vídeos entre otros" class="check" type="radio" name="type" id="rbetiquetatarea" value="T"  />
