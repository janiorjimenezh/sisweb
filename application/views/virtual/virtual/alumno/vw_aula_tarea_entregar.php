...
?>
<link rel="stylesheet" href="<?php echo $vbaseurl ?>resources/plugins/summernote/summernote-bs4.css">
...
<?php if  (($tiniciar==true) && ($tretraso==true)) { ?>
<script src="<?php echo $vbaseurl ?>resources/plugins/summernote/summernote-bs4.js"></script>
    ...
    myDropzone = new Dropzone(document.body, {
        ...
        removedfile: function(file) {
            ...
            Swal.fire({
                ...
                if (result.value) {
                        $.ajax({
                            url: base_url + 'virtualalumno/fn_delete_detalle',
                            type: 'POST',
                            data: {
                                "coddetalle": vinid,
                                "link": vilink 
