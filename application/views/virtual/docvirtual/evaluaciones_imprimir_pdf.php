...
$respuesta = $staresponse;
function echocard($vnum,$pgta,$carpeta,$respuesta){
    ...
    $detaenunciado = ($venunciadox != "") ? "<tr><td colspan='2' class='celda-texto'><small>$venunciadox</small></td></tr>" : "";
    $campoimg = ($imgpreg != "") ? "<tr><td colspan='2'><img class='preview_image_preg' $imgpreg style='height:15px'></td></tr>" : "";
            	...
            	<table class='divrptas'>";
                    ...
                    else
                    {
                        ...
                        foreach ($pgta->rpts as $key => $rp) {
                            ...
                            $divimg="";
                            if ($imgrpta != "") {
                                $divimg="<img class='preview_image_rpta' style='height:15px' $imgrpta>";
                            }
                            $rpicon="&#9744;";
                            ...
                            echo "<tr>
                            		<td width='25px'></td>
                            		<td class=''><div class='divicon'>$rpicon</div></td>
	...
	<div class="container-fluid">
        <?php 
            ...
            foreach ($preguntas as $key => $pregunta) {
                ...
                echocard($nropregunta,$pregunta,$pgmaterialConCeros,$respuesta);
            }
        ?>
