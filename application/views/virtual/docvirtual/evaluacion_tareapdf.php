...
<div style="width: 100%; float: left;">
	<table class="instruc"  autosize="1">
		...
		<tr>
			<td class="titulo" colspan="5"><?php echo "EVALUACIÓN TAREAS ".$iestp->nombre ?></td>
		</tr>
			...
			echo "<tr>
	            ...
	            foreach ($tareas as $keytar => $tar) {
	                if ($mat->idmiembro == $tar->codmiembro) {
	                    ...
	                    if ($tar->fentrega!=""){
	                    	$entrega = fechaCastellano($tar->fentrega,$meses_ES,$dias_ES)." ".date("h:i a",strtotime($tar->fentrega));
	                    }
	                    unset($tareas[$keytar]);
	                }
