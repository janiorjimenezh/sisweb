        ...
        <div class="card" id="divcard-indicadores">
            ...
            <div class="card-body p-2">
                <ul class="order-list" >
                        ...
                        case 'A':
                            if (isset($arr_arch[$mat->codigo])){
                                ...
                                else if($n==1)
                                {
                                    ...
                                    $nombre=print_vpd_link_il($icon,$mat->nombre,$archivo,$file->link);
                                    $detalle=$mat->detalle;
                                }
                                unset($files);
                                ...
                                $nombre="<span target='_blank' class='text-warning'><i class='fas fa-download mr-2'></i> <span class='text'>$mat->nombre</span> (sin archivos)</span>";
                                $detalle=$mat->detalle;
                            }
                            break;
                        case 'Y':
                    ...
                    ?>
                    <li data-tipo='<?php echo $mat->tipo ?>' data-id="<?php echo $mat->codigo ?>" data-espacio='<?php echo $esp ?>' class="item_aula espaciol-<?php echo $esp  ?>" data-titulo='<?php echo trim(strip_tags($mat->nombre)) ?>'>
                        ...
                        <div class="col-12 px-0 py-2">
                            <div class="row p-0">
                                ...
                                if (($mat->tipo!="E")) $botonedit = "<i class='btn-editar fas fa-pencil-alt ml-1' style='cursor:pointer;'></i>";
                                ...
                                $btnprogramado = ($viststat == "Auto") ? "<span class='ml-1 card_prog'><i class='far fa-clock'></i> $fecprog </span>" : "<span class='ml-3 card_prog'><i class='far ".$icon_eye_title."'></i></span>";
