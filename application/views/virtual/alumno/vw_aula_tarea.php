...
$usuarioest = $_SESSION['userActivo']->paterno." ".$_SESSION['userActivo']->materno." ". $_SESSION['userActivo']->nombres;
?>
        ...
        <form id='frm-insertupdate' name='frm-insertupdate'   method='post' accept-charset='utf-8'>
            ...
            <div class="card border-light">
                ...
                if ($finicia == "" || $finicia != "") {
                    ...
                    if ($fretraso != "") {
                        $tpvence = true;
                        if (strtotime($fretraso)<time()) $tpvence=false;
                    }
                ...
                <div class="card-body px-0 px-sm-3">
                    ...
                    <div class="row p-2 rowcolor">
                        <div class="col-6 col-md-3">
                            <span><a class="badge badge-pill badge-info" tabindex="0" data-toggle="popover" data-trigger="focus" title="Hora límite" data-content="Tiempo restante "> ? </a> Las entregas fuera de plazo     vencieron:  </span>
                        </div>
                        <div class="col-6 col-md-9">
                    ...
                    <div class="row p-2  rowcolor">
                        ...
                        <div class="col-6 col-md-9 text-success text-bold">
                            <?php foreach ($varchivostarea as $key => $filet){ 
                                ...
                                echo print_vpd_link($icon,$filet->nombre,$archivo,$filet->link);
                            } ?>
                        </div>
                    </div>
                    <?php endif ?>
