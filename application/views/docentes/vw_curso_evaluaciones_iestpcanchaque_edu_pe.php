                                ...
                                foreach ($indicadores as $indicador) {
                                    foreach ($evaluaciones as $evaluacion) {
                                        if ($evaluacion->indicador==$indicador->codigo){
                                            ...
                                            echo "<th  class='cell' data-indicador='$indicador->codigo' data-toggle='tooltip' data-placement='top' title='$evaluacion->nombre $indicador->norden' ><span class='rotar $color'>".$evaluacion->abrevia.$indicador->norden."</span></th>";
                                        }
                                    }
                                }
                            ?>
                            ...
                            foreach ($miembros as $miembro) {
                                if (($miembro->eliminado=='NO') && ($miembro->ocultar=='NO')){
                                    ...
                                    echo '<tr role="row" data-idmiembro="'.$miembro->idmiembro.'">
                                            ...
                                            $pf=$notas[$aidmiembro]['eval']['PI']['nota'];
                                            $colorpf="text-danger";
