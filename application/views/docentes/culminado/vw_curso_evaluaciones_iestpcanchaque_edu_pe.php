                ...
                <table class="table-registro" id="tbasistencia" role="table">
                    <thead role="rowgroup">
                        <tr role="row">
                            ...
                            ?>
                            <th   data-indicador='-1' role="columnheader"></th>
                            <th class="cell"  data-indicador='-1' role="columnheader"><span class='rotar text-success'>PI</span></th>
                            <th class="cell"  data-indicador='-1' role="columnheader"><span class='rotar text-success'>RC</span></th>
