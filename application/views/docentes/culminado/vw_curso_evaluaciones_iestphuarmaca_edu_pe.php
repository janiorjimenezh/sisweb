            ...
            include 'vw_curso_encabezado.php';
             if (!isset($notas)){  ?>
                ...
                <div class="callout callout-danger">
                        ...
                        <h5>Compruebe que existan <b>estudiantes matriculados</b></h5>
                ...
                <table class="table-registro" id="tbasistencia" role="table">
                    <thead role="rowgroup">
                        <tr role="row">
                            ...
                            <th class="cell"  data-indicador='0' role="columnheader"data-toggle='tooltip' data-placement='top' title='Promedio'>
                                ...
                                if ($miembro->eliminado=='NO'){
                                    ...
                                    echo '<tr role="row" data-idmiembro="'.$miembro->idmiembro.'">
                                            ...
                                            foreach ($indicadores as $indicador) {
                                                ...
                                                $nt=$notas[$aidmiembro]['eval'][$indicador->codigo]['PI']['nota'];
                                                $colornt="text-danger";
                                                if ($nt>=13) $colornt="text-primary";
                                                echo "<td class='cell text-right text-bold' >
                                                        <span class='$colornt'>
                                                        $nt</span>
                                                    </td>";
                                            ...
                                            $nt=$notas[$aidmiembro]['eval']['RC']['nota'];
                                            $colornt="text-danger";
                                            if ($nt>=13) $colornt="text-primary";
                                            echo "<td class='cell text-right' >
                                                    <span  class='$colornt'>
