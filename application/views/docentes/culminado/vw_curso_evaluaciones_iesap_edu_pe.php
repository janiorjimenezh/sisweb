            ...
            include 'vw_curso_encabezado.php';
             if (!isset($notas)){  ?>
                ...
                <div class="callout callout-danger">
                        ...
                        <h5>Compruebe que existan <b>Alumnos matriculados</b></h5>
                            ...
                            foreach ($miembros as $miembro) {
                                //if ($miembro->eliminado=='NO'){
                                    ...
                                    echo '<tr role="row" data-idmiembro="'.$miembro->idmiembro.'">
                                            ...
                                            foreach ($indicadores as $indicador) {
                                                foreach ($evaluaciones as $evaluacion) {
                                                    if ($evaluacion->indicador==$indicador->codigo){
                                                        ...
                                                        $anota= $notas[$aidmiembro]['eval'][$evaluacion->indicador][$evaluacion->abrevia]['nota'] ;
                                            ...
                                            echo "<td></td>";
                                            $anota= $notas[$aidmiembro]['eval']['PI']['nota'] ;
                                            $colorbtn="text-danger";
                                            if ($anota>=12.5) $colorbtn="text-primary";
