	...
	<table class="tbresumen"  autosize="1"  cellpadding="0">
		...
		<tr>
			<th  class="titulo2" colspan="12" align="center">
				<span>FÓRMULA PR= (U1 + U2 + U3)/3</span>
			</th>
		</tr>
		<tr >
			<th class="head-nro  rotar90"><span>N°</span></th>
			<th align="center" class="head rotar90">U1</th>
			<th align="center" class="head rotar90">U2</th>
			<th align="center" class="head rotar90">U3</th>
			<th align="center" class="head rotar90"></th>
			<th align="center" class="head rotar90"></th>
			<th align="center" class="head rotar90"></th>
			<th align="center" class="head rotar90"></th>
			<th align="center" class="head rotar90"></th>
			...
			foreach ($miembros as $miembro) {
					...
					echo '<tr role="row">';
						...
						foreach ($indicadores as $key => $indicador) {
							...
							$nota=$alumno[$miembro->idmiembro]['eval'][$indicador->codigo]['C1']['nota'];
