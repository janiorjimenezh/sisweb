	...
	<table class="tbresumen"  autosize="1"  cellpadding="0">
		...
		<tr>
			<th  class="titulo2" colspan="12" align="center">
				<span>FÓRMULA PR= (3EI + 3TA + 4EF)/10</span>
			</th>
		</tr>
		<tr >
			<th class="head-nro  rotar90"><span>N°</span></th>
			<th align="center" class="head rotar90">TA1</th>
			<th align="center" class="head rotar90">TA2</th>
			<th align="center" class="head rotar90">TA3</th>
			<th align="center" class="head rotar90">TA</th>
			<th align="center" class="head rotar90">EI1</th>
			<th align="center" class="head rotar90">EI2</th>
			<th align="center" class="head rotar90">EI</th>
			<th align="center" class="head rotar90">EF</th>
			<th align="center" class="head rotar90"><b>PR</b></th>
			<th align="center" class="head rotar90">RC</th>
			<th align="center" class="head rotar90"><b>PF</b></th>
		</tr>
		<?php 
			$numero=0;
			$ntotreg=50;
			...
			foreach ($miembros as $miembro) {
					...
					echo '<tr role="row">';
						...
						$nota=$alumno[$miembro->idmiembro]['eval']['PTA']['nota'];
                        $color = ($nota>=12.5) ? "negro":"rojo";
						echo "<td class='celda ".$color."'>".str_pad(intval($nota), 2, "0", STR_PAD_LEFT)."</td>";
						...
						for ($i=0; $i < 2; $i++) { 
							...
							$nota=$alumno[$miembro->idmiembro]['eval'][$indicador->codigo]['EU']['nota'];
                            $color = ($nota>=12.5) ? "negro":"rojo";
							echo "<td class='celda ".$color."'>".str_pad(intval($nota), 2, "0", STR_PAD_LEFT)."</td>";
						}
						//PEI
						$nota=$alumno[$miembro->idmiembro]['eval']['PEI']['nota'];
                        $color = ($nota>=12.5) ? "negro":"rojo";
						echo "<td class='celda ".$color."'>f".str_pad(intval($nota), 2, "0", STR_PAD_LEFT)."</td>";

						//EF
						$nota=$alumno[$miembro->idmiembro]['eval'][$indicadores[2]->codigo]['EF']['nota'];
                        $color = ($nota>=12.5) ? "negro":"rojo";
						echo "<td class='celda ".$color."'>".str_pad(intval($nota), 2, "0", STR_PAD_LEFT)."</td>";

						//ER
						$nota=$alumno[$miembro->idmiembro]['eval']['PI']['nota'];
                        $color = ($nota>=12.5) ? "negro":"rojo";
						echo "<td class='celda ".$color."'>".str_pad(intval($nota), 2, "0", STR_PAD_LEFT)."</td>";

						
						//COLUMNA DE RECUPERACIÓN
						$nota=$alumno[$miembro->idmiembro]['eval']['RC']['nota'];
                        $color = ($nota>=12.5) ? "negro":"rojo";
                        if ($nota==""){
						...
						$pf=$alumno[$miembro->idmiembro]['eval']['PF']['nota'];
