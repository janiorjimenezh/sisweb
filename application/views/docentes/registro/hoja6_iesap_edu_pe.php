...
<div style="width: 47%; float: left; ">
	<table class="tbnotas"  autosize="1"  cellpadding="0">
		...
		<tr >
			...
			<th align="center" class="head rotar90">EU</th>
			<th align="center" class="head rotar90"><b>PU</b></th>
			<th align="center" class="head rotar90">PC</th>
			<th align="center" class="head rotar90">TA</th>
			<th align="center" class="head rotar90">EU</th>
			<th align="center" class="head rotar90"><b>PU</b></th>
			...
			foreach ($miembros as $miembro) {
					...
					echo '<tr role="row">';
						...
						foreach ($indicadores as $key => $indicador) {
							$nota=$alumno[$miembro->idmiembro]['eval'][$indicador->codigo]['N1']['nota'];
                            $color = ($nota>=12.5) ? "negro":"rojo";
							echo "<td class='celda ".$color."'>".str_pad(intval($nota), 2, "0", STR_PAD_LEFT)."</td>";

							$nota=$alumno[$miembro->idmiembro]['eval'][$indicador->codigo]['N2']['nota'];
                            $color = ($nota>=12.5) ? "negro":"rojo";
							echo "<td class='celda ".$color."'>".str_pad(intval($nota), 2, "0", STR_PAD_LEFT)."</td>";

							$nota=$alumno[$miembro->idmiembro]['eval'][$indicador->codigo]['N3']['nota'];
                            $color = ($nota>=12.5) ? "negro":"rojo";
							echo "<td class='celda ".$color."'>".str_pad(intval($nota), 2, "0", STR_PAD_LEFT)."</td>";

							$nota=$alumno[$miembro->idmiembro]['eval'][$indicador->codigo]['C1']['nota'];
                            $color = ($nota>=12.5) ? "negro":"rojo";
							echo "<td class='celda ".$color."'><b>".str_pad(intval($nota), 2, "0", STR_PAD_LEFT)."</b></td>";

							
							$nind++;

						}
						//$nota=$alumno[$miembro->idmiembro]['eval']['PF']['nota'];
                            	//$color = ($nota>=12.5) ? "negro":"rojo";
								//echo "<td class='celda ".$color."'>".str_pad(intval($nota), 2, "0", STR_PAD_LEFT)."</td>";
