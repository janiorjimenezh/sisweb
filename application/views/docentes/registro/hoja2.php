...
<div style="width: 47%; float: left;">
	...
	<table class="tbguia">
		...
		<tr>
			<td colspan="2" class="celda-texto">En el desarrollo de la Unidad Didáctica se aplicará la metodología activa para el logro de los aprendizajes.</td>
		</tr>
		<tr>
			<td class="celda-vin">
				*
		...
		<tr>
			<td colspan="2">
				<img src="<?php echo base_url().'/resources/img/formula.png' ?>" alt="">
			</td>
		</tr>
		<tr>
