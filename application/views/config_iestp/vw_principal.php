	        ...
	        <div class="modal-content" id="divmodconfiguracion">
	            ...
	            <div class="modal-body" id="msgcuerpo">
	                <form id="frm_configsede" action="<?php echo $vbaseurl ?>sede/fn_update_configuracion" method="post" accept-charset='utf-8'>
	                    ...
	                    <div class="row mt-2 border-bottom">
	                        <div class="form-group col-9 col-md-10">
	                            <label for="checkbloquefotopf">El Estudiante puede subir foto perfil?</label>
	                        </div>
	                        <div class="form-group col-3 col-md-2">
	                        	<input  id="checkbloquefotopf" name="checkbloquefotopf" class="checkbloquefotopf" data-size="sm" type="checkbox" data-toggle="toggle" data-on="SI" data-off="NO" data-onstyle="success" data-offstyle="danger">
	                        </div>
	                    </div>
	                    <div class="row mt-2 border-bottom">
	                        <div class="form-group col-9 col-md-10">
	                            <label for="fictxtdias_anterioridad">Días con anterioridad para enviar un doc de pago</label>
	                        </div>
	                        <div class="form-group col-3 col-md-2">
	                        	<input  id="fictxtdias_anterioridad" name="fictxtdias_anterioridad" class="fictxtdias_anterioridad form-control form-control-sm" data-size="sm" type="number" min="1" max="3">
	                        </div>
	                    </div>
    ...
    function viewconfigurasede(codigo){
        ...
        $.ajax({
            ...
            success: function(e) {
                ...
                if (e.sedeup['conf_sube_foto'] == 'SI') {
                    $("#modconfiguracion #checkbloquefotopf").bootstrapToggle('on');
                    
                } else {
                    $("#modconfiguracion #checkbloquefotopf").bootstrapToggle('off');
                }

                $("#fictxtdias_anterioridad").val(e.sedeup['conf_dias_anter']);
