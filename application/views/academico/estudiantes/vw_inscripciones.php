    ...
    <div id="divboxhistorial" class="card">
      <div class="card-header p-2">
        <ul class="nav nav-pills">
          <li class="nav-item">
            <a class="nav-link active" href="#inscripciones" data-codmodalidad='%' id="insTabinscripciones" data-modalidad='inscripciones' data-toggle="tab">
              <u>Incripciones</u>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="#inscripciones" data-codmodalidad='1' id="insTabingresantes" data-modalidad='ingresantes' data-toggle="tab">
              <u>Ingresantes</u>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link " href="#inscripciones" data-codmodalidad='3' id="insTabreincorporaciones" data-modalidad='reincorporaciones' data-toggle="tab">
              <u>Reincorporaciones</u>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link " href="#inscripciones" data-codmodalidad='4' id="insTabinterno" data-modalidad='interno' data-toggle="tab">
              <u>Tras. Interno</u>
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link " href="#inscripciones" data-codmodalidad='2' id="insTabexterno" data-modalidad='externo' data-toggle="tab">
              <u>Tras. Externo</u>
            </a>
          </li>
      ...
      <div class="card-body p-2">
        <div class="tab-content">
          <div class="active tab-pane pt-3" id="inscripciones">
            ...
            <form id="frm-filtro-inscritos" name="frm-filtro-inscritos" action="<?php echo $vbaseurl ?>academico/estudiantes/filtro/incripciones" method="post" accept-charset='utf-8'>
              ...
              <div class="row my-2">
                ...
                <div class="form-group has-float-label col-12 col-sm-2">
                  <select data-currentvalue='' class="form-control form-control-sm" id="fbus-convalida" name="fbus-convalida" placeholder="Sección" required >
                    <option value="%">Todas</option>
                    <option value="SI">SI</option>
                    <option value="NO">NO</option>
                  </select>
                  <label for="fbus-convalida"> Convalida</label>
                </div>
...
<script>
  ...
  $(document).ready(function() {
    ...
    $('.nav-pills a').on('shown.bs.tab', function(event){
      ...
      // }
        ...
        var newurl = window.location.protocol + "//" + window.location.host + '' + '/academico/estudiantes/inscripciones/' + $(event.target).data('modalidad') + '?sb=academico';
  ...
  $(".btn-excel").click(function(e) {
    ...
    if ((valnavtap == "") || (valnavtap == "inscripciones")) {
      urlnavtap = "inscripciones";
    } else {
      urlnavtap = valnavtap;
    }
    ...
    var url=base_url + enlaceurl + '?cp=' + $("#fbus-periodo").val() + '&cc=' + $("#fbus-carrera").val()  + '&tn=' +  $("#fbus-turno").val()  + '&cl=' +  $("#fbus-ciclo").val() + '&ccp=' + $("#fbus-campania").val() + '&cs=' + $("#fbus-seccion").val() +'&ap=' + $("#fbus-txtbuscar").val() +'&mdld=' + $('#fbus-modalidad').val() +'&sede=' + $('#fbus-sede').val() + '&cnvl=' + $('#fbus-convalida');
    var llenos=0;
    if ($("#fbus-txtbuscar").val()!=="") llenos=llenos + 2;
    if ($("#fbus-periodo").val()!=="%") llenos++;
    if ($("#fbus-campania").val()!=="%") llenos++;
