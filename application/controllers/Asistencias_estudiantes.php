...
class Asistencias_estudiantes extends CI_Controller {
	private $ci;
	...
	public function index(){
		$ahead= array('page_title' =>'Asistencias | '.$this->ci->config->item('erp_title') );
		$asidebar= array('menu_padre' =>'asistencias','menu_hijo' =>'');
		...
		$this->load->view('asistencias_estudiante/vw_asistencias', $a_ins);
		...
		if ($this->input->is_ajax_request())
		{
			...
			else
			{
                ...
                foreach ($unidades as $key => $und) {
                   ...
                   $rsoptions=$rsoptions. "<option value='$und->id'>$und->uninom ($und->cicnom)</option>";
                }
